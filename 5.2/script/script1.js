...
function ListenersButtonFeedbackClose() {
	let closeBackground = document.getElementsByClassName('background_form'),
		...
		blackFon = document.getElementsByClassName('background_form'),
		feedbackForm = document.getElementsByClassName('feedback_form');
	...
	function goToHell() {
		feedbackForm[0].style.top = '-100%';
		blackFon[0].style.top = '-100%';
	}
}
...
function createFilmBlock(src, name, description, addClass) 
{
